...
class Converter {
    ...
    convertFunction(func, arrow = false, classy = false) {
        ...
        if (func.returns) {
            ...
            if (func.returns.optional && (returnType !== 'any' || returnType !== 'void')) returnType += ' | void';
            ...
            returnType = `Promise<${parameters.join(', ') || 'void'}>${callback.optional ? ' | void' : ''}`
        }
    ...
    convertEvent(event, classy = false) {
        ...
        if (event.returns) {
            ...
            if (event.returns.optional && (returnType !== 'any' || returnType !== 'void')) returnType += ' | void';
        }
